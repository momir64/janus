...
class LocalDestination(override val envFile: String) : Destination {
...
class RemoteDestination(private val sftp: Sftp, uid: Int?, directory: String) : Destination {
    override val root = uid?.let { "/dev/shm/lokot-$it" } ?: "$directory/.lokot-secrets"
    override val envFile = "$directory/.env"
