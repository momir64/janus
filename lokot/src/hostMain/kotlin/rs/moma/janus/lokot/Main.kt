...
private fun run(args: Array<String>): Int = when (args.firstOrNull()) {
    ...
    "selftest" -> runSelftest()
        ...
        println("             --rp <id> enrols that first key for a browser at that origin")
        ...
        println("             both take an optional user@host:/path/to/repo, for another machine")
        ...
        println("             --rp <id> enrols one for a browser at that origin instead")
