...
fun runInit(arguments: List<String>): Int {
    ...
    try {
        ...
        destination.write(destination.vaultFile, LokotFile.build(header, VaultBody(declared, values.asChars()), dek))
        dek.wipe()
...
fun runAddKey(arguments: List<String>): Int {
    ...
    return withVault(arguments, "open the vault with") { destination, unlocked ->
        ...
        try {
            ...
            destination.write(destination.vaultFile, LokotFile.build(extended, unlocked.body, dek))
...
fun runRekey(arguments: List<String>): Int {
    ...
    return withVault(arguments, "rekey with", rpId) { destination, unlocked ->
        ...
        try {
            ...
            destination.write(destination.vaultFile, LokotFile.build(rekeyed, unlocked.body, dek))
